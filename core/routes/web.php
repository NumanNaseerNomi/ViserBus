...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        // Agents Module 10-03-2023
        Route::get('agents', 'ManageAgentsController@allAgents')->name('agents.all');
        Route::get('agents/create', 'ManageAgentsController@createAgent')->name('agents.create');
        Route::post('agents/store', 'ManageAgentsController@storeAgent')->name('agents.store');
        Route::get('agents/{scope}/search', 'ManageAgentsController@search')->name('agents.search');
        Route::get('agents/detail/{id}', 'ManageAgentsController@detail')->name('agents.detail');
        Route::post('agents/update/{id}', 'ManageAgentsController@update')->name('agents.update');
        Route::get('agents/send-email/{id}', 'ManageAgentsController@showEmailSingleForm')->name('agents.email.single');
        Route::post('agents/send-email/{id}', 'ManageAgentsController@sendEmailSingle')->name('agents.email.single');
        Route::get('agents/transaction-details/{id}', 'ManageAgentsController@transactionDetails')->name('agents.transaction.details');
        Route::get('agents/login/history/{id}', 'ManageAgentsController@userLoginHistory')->name('agents.login.history.single');
        ...
        */
        ...
        Route::get('report/bookings', 'ReportController@booking_reports')->name('report.bookings');
...
Route::name('user.')->group(function () {
    ...
    //Route::post('register1', 'Auth\RegisterController@register1')->middleware('regStatus');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('agentdash', 'UserController@agentdash')->name('agentdash');
...
Route::get('/agentticket/{id}/{slug}', 'SiteController@agentshowSeat')->name('agentticket.seats');
...
Route::get('ticket/agentticketsearch','SiteController@agentticketSearch')->name('agentticketsearch');
