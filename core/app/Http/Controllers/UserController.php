...
class UserController extends Controller
{
    ...
    public function agentdash()
    {
        ...
        return view($this->activeTemplate . 'user.agentdash', compact('pageTitle', 'emptyMessage','fleetType', 'trips','routes' ,'schedules', 'layout', 'category'));
    }
