        ...
        <div class="card" >
            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <form action="{{route('admin.report.indivisual')}}" class="form-inline">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" id="category" class="form-control" autocomplete="off" value="{{ request()->category }}" required>
